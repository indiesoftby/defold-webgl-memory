...
var WebGLMemory = {
  warnShown: false,
  cstringify: function cstringify(obj) {
    var str = JSON.stringify(obj);
    var cstr = stringToNewUTF8(str);
    return cstr;
  },
  addExtraInfo: function addExtraInfo(obj) {
...
function _WebGLMemory_GetInfo() {
  ...
  if (ext) {
    ...
    if (!WebGLMemory.warnShown) {
      ...
      console.warn("Unable to get the `GMAN_webgl_memory` extension - webgl-memory.js hasn't been loaded yet?");
    }
